...
#
for i in torch.arange(9,10):
 samples = sample(alpha=1.5,path='/scratch/private/eunbiyoon/sub_Levy/conditionalCIFAR10batch65lr0.0001ch128ch_mult[1, 2, 2, 2]num_res4dropout0.1clamp100.01.5_0.1_20/ckpt/CIFAR10batch65ch128ch_mult[1, 2, 2, 2]num_res4dropout0.1clamp100.0_epoch500_1.5_0.1_20.pth',
                   beta_min=0.1, beta_max=20, sampler='pc_sampler2', batch_size=36, num_steps=1000, LM_steps=20,
                   h=1.3,y=None, num_classes= 10,
                   Predictor=True, Corrector=False, trajectory=False, clamp=100, initial_clamp=100, clamp_mode="constant",
                   datasets="CIFAR10", name=str(i), mode ='approximation',resolution=32, ch=128, ch_mult=[1, 2, 2,2], num_res_blocks=4,
                 dir_path='/scratch/private/eunbiyoon/sub_Levy')
 # for i in torch.arange(9, 10):
 #     samples = sample(alpha=1.5,
 #                      path='/scratch/private/eunbiyoon/sub_Levy/conditionalCIFAR10batch64lr0.0001ch128ch_mult[1, 2, 2, 2]num_res4dropout0.1clamp1000.01.5_0.1_20/ckpt/CIFAR10batch64ch128ch_mult[1, 2, 2, 2]num_res4dropout0.1clamp1000.0_epoch600_1.5_0.1_20.pth',
 #                      beta_min=0.1, beta_max=20, sampler='pc_sampler2', batch_size=36, num_steps=1000, LM_steps=20,
 #                      h=1.3, y=None, num_classes=10,
 #                      Predictor=True, Corrector=False, trajectory=False, clamp=1000, initial_clamp=1000,
 #                      clamp_mode="constant",
 #                      datasets="CIFAR10", name=str(i), mode='approximation', resolution=32, ch=128,
 #                      ch_mult=[1, 2, 2, 2], num_res_blocks=4,
 #                      dir_path='/scratch/private/eunbiyoon/sub_Levy')
